...
// import { vetherAddr, vetherAbi, getUniswapTokenPriceEth, getExchangeAddr, getExplorerURL } from '../../client/web3.js'
...
export const TokenTable = () => {
    ...
    //     const spartaBalance = await contract.methods.balanceOf(address).call()
    //     setAccount({
    //         address: address,
