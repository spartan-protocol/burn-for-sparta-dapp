        ...
        <>
            <Col xs={24} sm={9}>
                <Row>
                    <Col xs={24} sm={12}>
                        <Center>
                            <Text size={32} style={{ marginBottom: 0 }}>{currency(+props.eraData.currentBurn, 1, 4, 'BNB')}</Text>
                        </Center>
                    </Col>
                    <Col xs={24} sm={12}>
                        <Center>
                ...
                <Row>
                    <Col xs={24} sm={12}>
                        <Center><Text size={24} margin={"0px 0px"}>{currency((props.eraData.currentBurn / props.eraData.emission), 1, 6, 'BNB')}</Text></Center>
                    </Col>
                    <Col xs={24} sm={12}>
                ...
                <Row>
                    <Center><LabelGrey margin={"0px 0px 10px"}>IMPLIED VALUE OF Spartan TODAY</LabelGrey></Center>
                    <br/>
                </Row>
            </Col>
        </>
