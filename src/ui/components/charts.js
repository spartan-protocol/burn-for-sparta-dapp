...
export const ChartClaim = (props) => {
    ...
    var chartConfig = getChartConfig()
    chartConfig.options.title.text = 'Spartan Emitted Daily'
    chartConfig.data.datasets[0].label = 'Spartan Unclaimed'
    chartConfig.options.scales.yAxes[0].scaleLabel.labelString = 'Spartan'
    chartConfig.options.scales.xAxes[0].scaleLabel.labelString = 'Day'
    ...
    const setChart = async (claimArray, newChartInstance) => {
        ...
        chartConfig.options.scales.yAxes.push(rightAxisConfig())
        chartConfig.options.scales.yAxes[1].scaleLabel.labelString = 'Spartan Supply'
        newChartInstance.update()
    }
...
export const ChartDistro = (props) => {
    ...
    chartConfig.options.title.text = 'Spartan Distribution'
    chartConfig.data.datasets[0].label = 'Member Ownership'
    chartConfig.options.scales.yAxes[0].scaleLabel.labelString = 'Spartan (linear)'
    ...
    chartConfig.options.scales.yAxes[1].scaleLabel.labelString = 'Spartan (logarithmic)'
...
export const ChartPie = (props) => {
    ...
    chartConfig.options.title.text = 'Spartan Ownership'
    chartConfig.data.datasets[0].label = 'Member Ownership'
    chartConfig.options.scales.yAxes[0].scaleLabel.labelString = 'Spartan'
    chartConfig.options.scales.xAxes[0].scaleLabel.labelString = 'Member'
...
export const ChartEmission = (props) => {
    ...
    chartConfig.options.title.text = 'Spartan Emission'
    ...
    return(
        <div style={ChartStyles}>
            <div style={paneStyles}>
                <Center><LabelGrey>Spartan Overview</LabelGrey></Center>
                ...
                <Row style={rowStyles}>
                    ...
                    >
                        ...
                        <Text size={1.25*props.size}>{currency(+emissionData.totalBurnt, 0, 2, 'BNB')}</Text>
                    </Col>
                    <Col xs={12}
                         style={{
                             padding: '0 1rem'
                    ...
                    >
                        ...
                        <Text size={1.25*props.size}>{currency(+emissionData.totalFees, 0, 2, 'SPARTA')}</Text>
                    </Col>
                </Row>
                ...
                <Row style={rowStyles}>
                    ...
                    >
                        ...
                        <Text size={1.25*props.size}>{currency(eraData.emission, 0, 2, 'SPARTA')}</Text>
                    </Col>
                    <Col xs={12}
                         style={{
                             padding: '0 1rem'
                    ...
                    >
                        ...
                        <Text size={1.25*props.size}>{currency((eraData.emission / 2), 0, 2, 'SPARTA')}</Text>
                    </Col>
                </Row>
                <Row style={rowStyles}>
                    <Col xs={8}
