...
import { LoadingOutlined, DoubleRightOutlined, UnlockOutlined } from '@ant-design/icons';
...
import { bn, formatBN, convertFromWei, convertToWei } from '../../common/utils'
import { getSwapOutput, getSwapSlip } from '../../common/oldMath'

import {BNB_ADDR, SPARTA_ADDR, ROUTER_ADDR, getRouterContract, getTokenContract, getListedTokens, getPoolData, getTokenData, getTokenDetails, getListedPools, getPoolsData, getPool
} from '../../client/web3'
...
const NewSwap = (props) => {
    ...
    return (
        <>
            ...
            <HR></HR>
            <Button onClick={back} type={'secondary'} size={'large'} >BACK</Button>
